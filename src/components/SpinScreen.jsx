...
export default function Spin3Screen({ onNavigate, winData }) {
  ...
  useEffect(() => {
    const loadCaseData = async () => {
      try {
        setIsLoading(true);
        console.log('🔄 Загрузка данных кейса 2 для спина...');
    ...
    const getDefaultDemoProbabilities = () => {
      return [
        { img: getImageUrl('/static/gifts/heartlocket.png'), price: '1329.99 TON', probability: 0.002, item_type: 'tg_gift', name: 'Heart Locket' },
        { img: getImageUrl('/static/gifts/nailbracelet.png'), price: '95.49 TON', probability: 0.007, item_type: 'tg_gift', name: 'Nail Bracelet' },
        { img: getImageUrl('/static/gifts/nekohelmet.png'), price: '28.86 TON', probability: 0.01, item_type: 'tg_gift', name: 'Neko Helmet' },
        { img: getImageUrl('/static/gifts/toybear.png'), price: '25.85 TON', probability: 0.02, item_type: 'tg_gift', name: 'Toy Bear' },
        { img: getImageUrl('/static/gifts/ionicdryer.png'), price: '13.36 TON', probability: 0.03, item_type: 'tg_gift', name: 'Ionic Dryer' },
        { img: getImageUrl('/static/gifts/lovepotion.png'), price: '11.06 TON', probability: 0.04, item_type: 'tg_gift', name: 'Love Potion' },
        { img: getImageUrl('/static/gifts/trappedheart.png'), price: '9.86 TON', probability: 0.05, item_type: 'tg_gift', name: 'Trapped Heart' },
        { img: getImageUrl('/static/gifts/skystilettos.png'), price: '7.1 TON', probability: 0.1, item_type: 'tg_gift', name: 'Sky Stilettos' },
        { img: getImageUrl('/static/gifts/bunnymuffin.png'), price: '4.38 TON', probability: 0.2, item_type: 'tg_gift', name: 'Bunny Muffin' },
        { img: cardton3, price: '2 TON', probability: 0.26, item_type: 'reward_ton', name: 'TON 2' },
        { img: getImageUrl('/static/gifts/bdaycandle.png'), price: '2.48 TON', probability: 0.23, item_type: 'tg_gift', name: 'B-day Candle' },
        { img: getImageUrl('/static/gifts/deskcalendar.png'), price: '2.28 TON', probability: 0.22, item_type: 'tg_gift', name: 'Desk Calendar' },
        { img: cardton3, price: '1.5 TON', probability: 0.22, item_type: 'reward_ton', name: 'TON 1.5' },
        { img: cardton3, price: '1 TON', probability: 0.22, item_type: 'reward_ton', name: 'TON 1' }
      ];
    };
  ...
  useEffect(() => {
    ...
    console.log('🔄 Spin3Screen инициализация, isDemoMode:', isDemoMode, 'winData:', winData);
  ...
  const isCardtonItem = (item) => {
    return item && (item.item_type === 'reward_ton' || item.img === cardton3);
  };
