...
export default function Spin2Screen({ onNavigate, winData }) {
  ...
  useEffect(() => {
    const loadCaseData = async () => {
      try {
        ...
        const response = await casesApi.getCaseById(3);
  ...
  useEffect(() => {
    ...
    console.log('🔄 Spin2Screen инициализация');
    ...
    const initializeData = () => {
      ...
      // РЕАЛЬНЫЙ РЕЖИМ БЕЗ winData (ошибка)
        ...
        setTimeout(() => onNavigate('card2'), 100);
        return;
      }
